...
class AudioW {
  constructor(sepValue) {
    ...
    // this.audio.src = '/static/bg.ogg';
    this.audio.src = '/static/Summer Of Haze & Pixelord - Ripple Hero - 01 Ripple Hero.ogg';
    this.audio.crossOrigin = "anonymous";
...
class Webgl {
  constructor(width, height, audio) {
    ...
    for (var i = 0; i < this.waves.length; i++) {
      this.waves[i].position.set(positions[i][0], positions[i][1], positions[i][2]);
